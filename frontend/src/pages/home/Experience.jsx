...
import { Sparkles, ShieldCheck, Award, Star, ArrowRight } from "lucide-react";
...
const Experience = ({ image = "/assets/hotels/hotel-01.jpg" }) => {
  return (
        ...
        <div className="items-center gap-16 lg:grid lg:grid-cols-[1.05fr_0.95fr]">
          ...
          >
            ...
            >
              ...
              <h3 className="mt-3 font-serif text-4xl text-white">150+</h3>
          ...
          >
            ...
            >
              Crafted for
              <span className="block text-gold-400 italic">Extraordinary</span>
            ...
            >
              Every AureliaStay destination is thoughtfully selected to deliver
              timeless architecture, discreet hospitality, exceptional comfort
              and unforgettable experiences for travellers seeking more than
              simply a place to stay.
            </motion.p>
            ...
            <motion.div variants={staggerContainer(0.12)} className="space-y-6">
