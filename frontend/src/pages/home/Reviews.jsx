...
const Avatar = ({ name }) => (
  <div
    className=">  relative>  flex>  h-14>  w-14>  items-center>  justify-center>  rounded-full>  bg-gradient-to-br>  from-[#E9D18A]>  via-[#D4AF37]>  to-[#8A6A1C]>  shadow-[0_12px_35px_rgba(212,175,55,.45)]>  shrink-0>"
>
    <div
      className="  flex  h-11  w-11  items-center  justify-center  rounded-full  bg-[#151515]  text-sm  font-semibold  text-[#F6E4A7]"
    >
      {initials(name)}
    </div>
  </div>
...
const ReviewCard = memo(({ review }) => {
  return (
    <motion.article
      ...
      className="  group  relative  overflow-hidden  rounded-[30px]  border  border-[#D4AF37]/20  bg-gradient-to-b  from-[#1D1B17]  via-[#171512]  to-[#111111]  p-6  mb-2  ml-2  lg:ml-5  md:ml-5  mt-4  shadow-[0_25px_60px_rgba(0,0,0,.45)]  transition-all  duration-500  hover:border-[#D4AF37]/60  w-[340px]  hover:shadow-[0_30px_70px_rgba(212,175,55,.22)]  h-full"
    >
      {/* Gold Glow */}

      <div
        className="  absolute  -top-32  right-[-80px]  h-60  w-60  rounded-full  bg-[#D4AF37]/10  blur-[120px]  opacity-0  transition  duration-700  group-hover:opacity-100"
      />

      {/* Quote */}

      <Quote
        className="  absolute  right-6  top-6  h-20  w-20  text-[#D4AF37]/8"
      />
      ...
      <div className="flex items-center justify-between">
        ...
        {review.verified && (
          <span
            className="  inline-flex  items-center  gap-1  rounded-full  border  border-[#D4AF37]/30  bg-[#D4AF37]/10  px-3  py-1  text-[10px]  font-semibold  uppercase  tracking-[0.18em]  text-[#E6C86C]"
          >
            <BadgeCheck size={12} />
      ...
      <blockquote
        className="  mt-6  text-[15px]  leading-8  text-white/80  min-h-[140px]"
      >
        "{review.review}"
      </blockquote>
        ...
        {SUB_RATINGS.map((item) => {
          ...
          return (
            ...
            >
              ...
              <span
                className="  w-24  text-[10px]  uppercase  tracking-[0.18em]  text-white/50"
              >
                {item.label}
              </span>
      ...
      >
        ...
        <div>
          ...
          <div
            className="  mt-1  flex  items-center  gap-1  text-sm  text-white/60"
          >
            <MapPin
              size={13}
      ...
      <div
        className="  mt-2  border-t  border-white/10  pt-5  space-y-2"
>
      ...
      <Container className="relative z-10">
        ...
        >
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-white/70">
            Every stay creates unforgettable memories. Discover why
            travelers from around the world choose AureliaStay for
        ...
        >
          ...
          <div className="rounded-[34px] border border-[#D4AF37]/20 bg-white/5 p-8 text-center backdrop-blur-xl shadow-[0_25px_60px_rgba(0,0,0,.45)]">
            ...
            <div className="mt-5 flex items-end justify-center gap-2">
              ...
              <span className="mb-2 text-3xl text-white/40">
                /5
              </span>
        ...
        >
          ...
          >
            Luxury Hospitality • Premium Suites • Fine Dining •
