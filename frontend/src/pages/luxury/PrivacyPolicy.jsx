...
import { PRIVACY_SECTIONS } from "@/data/luxury/legal";

/**
 * /privacy-policy — privacy document.
 */
const PrivacyPolicy = () => (
  <>
    <Seo title="Privacy Policy" description="How Aurelia Stay collects, uses and protects your information." />
    ...
    <section className="bg-[#0B0B0B]">
      <Container className="py-28 sm:py-32">
        <motion.div variants={fadeInUp} initial="hidden" animate="visible" className="mx-auto max-w-3xl">
          ...
          <h1 className="lux-title mt-4">Privacy Policy</h1>
